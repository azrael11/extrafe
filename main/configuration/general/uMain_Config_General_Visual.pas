...
procedure Load;
begin
  mainScene.Config.Main.R.General.Visual.Keyboard_Group := TGroupBox.Create(mainScene.Config.Main.R.General.Tab_Item[0]);
  mainScene.Config.Main.R.General.Visual.Keyboard_Group.Name := 'Main_Config_General_Visual_Keyboard_Group';
  mainScene.Config.Main.R.General.Visual.Keyboard_Group.Parent := mainScene.Config.Main.R.General.Tab_Item[0];
  mainScene.Config.Main.R.General.Visual.Keyboard_Group.SetBounds(10, 10, mainScene.Config.Main.R.General.Contol.Width - 20, 160);
