...
begin
  ...
  begin
    ...
    mainScene.Config.Main.R.info.Others.Layout.Name := 'Main_Config_Info_Others';
    mainScene.Config.Main.R.info.Others.Layout.Parent := mainScene.Config.Main.R.info.TabItem[3];
