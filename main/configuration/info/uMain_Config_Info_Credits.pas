...
begin
  ...
  extrafe.prog.State := 'main_config_info_credits';

  if mainScene.Config.Main.R.info.Credits.Layout = nil then
  begin

    mainScene.Config.Main.R.info.Credits.Layout := TLayout.Create(mainScene.Config.Main.R.info.TabItem[4]);
    mainScene.Config.Main.R.info.Credits.Layout.Name := 'Main_Config_Info_Credits';
    mainScene.Config.Main.R.info.Credits.Layout.Parent := mainScene.Config.Main.R.info.TabItem[4];
    mainScene.Config.Main.R.info.Credits.Layout.SetBounds(0, 0, mainScene.Config.Main.R.info.TabControl.Width, mainScene.Config.Main.R.info.TabControl.Height);
    mainScene.Config.Main.R.info.Credits.Layout.Visible := True;

    mainScene.Config.Main.R.info.Credits.Panel := TPanel.Create(mainScene.Config.Main.R.info.Credits.Layout);
    mainScene.Config.Main.R.info.Credits.Panel.Name := 'Main_Config_Info_Credits_Panel';
    mainScene.Config.Main.R.info.Credits.Panel.Parent := mainScene.Config.Main.R.info.Credits.Layout;
    mainScene.Config.Main.R.info.Credits.Panel.SetBounds(0, 0, mainScene.Config.Main.R.info.Credits.Layout.Width,
      mainScene.Config.Main.R.info.Credits.Layout.Height);
