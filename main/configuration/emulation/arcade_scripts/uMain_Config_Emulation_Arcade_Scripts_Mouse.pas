...
begin
  if (TButton(Sender).Name = 'Script_Mame_Install_Main_Tab1_Cancel') or
    (TButton(Sender).Name = 'Script_Mame_Install_Main_Tab2_Cancel') or
    (TButton(Sender).Name = 'Script_Mame_Install_Main_Tab3_Cancel') or
    (TButton(Sender).Name = 'Script_Mame_Install_Main_Tab4_Close') then
    uEmulation_Arcade_Mame_Install_Free
  else if TButton(Sender).Name = 'Script_Mame_Install_Main_Tab1_Next' then
    Script_Mame_Install.Main.Control.SetActiveTabWithTransition(Script_Mame_Install.Main.Tabs[1],
      TTabTransition.Slide)
  else if TButton(Sender).Name = 'Script_Mame_Install_Main_Tab2_Back' then
    Script_Mame_Install.Main.Control.SetActiveTabWithTransition(Script_Mame_Install.Main.Tabs[0],
    ...
    Script_Mame_Install.Main.Control.SetActiveTabWithTransition(Script_Mame_Install.Main.Tabs[3],
      TTabTransition.Slide)
  else if TButton(Sender).Name = 'Script_Mame_Install_Main_Tab3_Back' then
    Script_Mame_Install.Main.Control.SetActiveTabWithTransition(Script_Mame_Install.Main.Tabs[1],
      TTabTransition.Slide, TTabTransitionDirection.Reversed)
  else if (TButton(Sender).Name = 'Script_Mame_Uninstall_Main_Tab1_Cancel') or
    (TButton(Sender).Name = 'Script_Mame_Uninstall_Main_Tab2_Cancel') then
    uEmulation_Arcade_Mame_Uninstall_Free
  else if TButton(Sender).Name = 'Script_Mame_Uninstall_Main_Tab1_Next' then
    Script_Mame_Uninstall.Main.Control.SetActiveTabWithTransition(Script_Mame_Uninstall.Main.Tabs[1],
      TTabTransition.Slide)
  else if TButton(Sender).Name = 'Script_Mame_Uninstall_Main_Tab2_Back' then
    Script_Mame_Uninstall.Main.Control.SetActiveTabWithTransition(Script_Mame_Uninstall.Main.Tabs[0],
      TTabTransition.Slide, TTabTransitionDirection.Reversed)
...
begin
  if (TRadioButton(Sender).Name = 'Script_Mame_Install_Main_Tab2_Radio_1') or
    (TRadioButton(Sender).Name = 'Script_Mame_Install_Main_Tab2_Radio_2') then
