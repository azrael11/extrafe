...
begin
  ...
  vColumns := 'USER_ID';
  vValues := vLocal_Num;
  Query_Insert(ExtraFE_Query_Local, 'USER_STATISTICS', vColumns, vValues);
  ...
  vValues := vLocal_Num + ''', ''' + vPath[0] + ''', ''' + vPath[1] + ''', ''' + vPath[2] + ''', ''' + vPath[3] + ''', ''' + vPath[4] + ''', ''' + vPath[5] +
    ''', ''' + vPath[6] + ''', ''' + vPath[7] + ''', ''' + vPath[8] + ''', ''' + vPath[9] + ''', ''' + vPath[10] + ''' , ''' + vPath[11] + ''', ''' + vPath[12]
    + ''', ''' + vPath[13] + ''', ''' + vPath[14] + ''', ''' + vPath[15] + ''', ''' + vPath[16] + ''', ''' + vPath[17] + ''', ''' + vPath[18] + ''', ''' +
    vPath[19] + ''', ''' + vPath[20] + ''', ''' + vPath[21] + ''', ''' + vPath[22] + ''', ''' + vPath[23] + ''', ''' + vPath[24] + ''', ''' + vPath[25] + '';
