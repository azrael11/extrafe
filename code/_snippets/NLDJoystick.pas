...
//    procedure WndProc(var vMessage: TMessage); virtual;
  public
...
//procedure TNLDJoystick.WndProc(var vMessage: TMessage);
//begin
//  if not FAdvanced then
//    ProcessSimple(TMMJoyMsg(vMessage))
//  else if vMessage.Msg = WM_TIMER then
//    ProcessAdvanced
//  else
//    Dispatch(vMessage);
//end;
