...
{$R 'Tutorial03.res' 'Tutorial03.rc'}
{%File 'Tutorial03.fx'}
...
begin
  ...
  g_hWnd := CreateWindow('TutorialWindowClass', 'Direct3D 10 Tutorial 3: Shaders and Effect System', WS_OVERLAPPEDWINDOW,
...
{$ENDIF}
  ...
  {$ENDIF}
  Result := D3DX10CreateEffectFromFileA('Tutorial03.fx', nil, nil, 'fx_4_0', dwShaderFlags, 0,
