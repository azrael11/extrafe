...
begin
  ...
  vWeather.Config.main.Right.Towns.GoUp.SetBounds(8, 340, 24, 24);
  ...
  vWeather.Config.main.Right.Towns.GoDown.SetBounds(8, 370, 24, 24);
  ...
  vWeather.Config.main.Right.Towns.Refresh_Icon := TText.Create(vWeather.Config.main.Right.Towns.Action);
  vWeather.Config.main.Right.Towns.Refresh_Icon.name := 'A_W_Config_Towns_Refresh';
  vWeather.Config.main.Right.Towns.Refresh_Icon.Parent := vWeather.Config.main.Right.Towns.Action;
  vWeather.Config.main.Right.Towns.Refresh_Icon.SetBounds(8, 420, 24, 24);
  vWeather.Config.main.Right.Towns.Refresh_Icon.Font.Family := 'IcoMoon-Free';
  vWeather.Config.main.Right.Towns.Refresh_Icon.Font.Size := 24;
  vWeather.Config.main.Right.Towns.Refresh_Icon.TextSettings.FontColor := TAlphaColorRec.Grey;
  vWeather.Config.main.Right.Towns.Refresh_Icon.Text := #$ea2e;
  vWeather.Config.main.Right.Towns.Refresh_Icon.OnClick := addons.weather.Input.mouse_config.Text.OnMouseClick;
  vWeather.Config.main.Right.Towns.Refresh_Icon.OnMouseEnter := addons.weather.Input.mouse_config.Text.OnMouseEnter;
  vWeather.Config.main.Right.Towns.Refresh_Icon.OnMouseLeave := addons.weather.Input.mouse_config.Text.OnMouseLeave;
  vWeather.Config.main.Right.Towns.Refresh_Icon.Visible := True;

  vWeather.Config.main.Right.Towns.Refresh_Glow := TGlowEffect.Create(vWeather.Config.main.Right.Towns.Refresh_Icon);
...
begin
  if addons.weather.Action.Provider = 'yahoo' then
    uWeather_Providers_Yahoo.Load_Towns
  else
...
begin
  ...
  begin
    ...
    begin
      ...
      vWeather.Config.main.Right.Towns.Refresh_Icon.TextSettings.FontColor := TAlphaColorRec.Deepskyblue;
