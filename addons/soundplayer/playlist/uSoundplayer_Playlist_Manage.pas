...
begin
  ...
  begin
    ...
    CreateHeader(vSoundplayer.Playlist.Manage.Panel, 'IcoMoon-Free', #$e9bb, 'Manage playlists.');
    ...
    vSoundplayer.Playlist.Manage.main.Panel.SetBounds(0, 30, 600, vSoundplayer.Playlist.Manage.Panel.Height - 30);
    ...
    vSoundplayer.Playlist.Manage.main.Grid.SetBounds(10, 10, vSoundplayer.Playlist.Manage.Panel.Width - 70, vSoundplayer.Playlist.Manage.Panel.Height - 85);
    vSoundplayer.Playlist.Manage.main.Grid.Options := vSoundplayer.Playlist.Manage.main.Grid.Options +
      [TGridOption.AlternatingRowBackground, TGridOption.ColLines, TGridOption.RowLines, TGridOption.RowSelect, TGridOption.Tabs, TGridOption.Header,
      TGridOption.AutoDisplacement];
    vSoundplayer.Playlist.Manage.main.Grid.OnSelectCell := addons.soundplayer.Input.mouse.Stringgrid.OnSelectSell;
    ...
    vSoundplayer.Playlist.Manage.main.Load.SetBounds(50, vSoundplayer.Playlist.Manage.main.Panel.Height - 36, 100, 25);
    ...
    vSoundplayer.Playlist.Manage.main.Cancel.SetBounds(vSoundplayer.Playlist.Manage.main.Grid.Width - 150, vSoundplayer.Playlist.Manage.main.Panel.Height -
      36, 100, 25);
    ...
    vSoundplayer.Playlist.Manage.main.Up_Grey := TMonochromeEffect.Create(vSoundplayer.Playlist.Manage.main.Up);
    ...
    vSoundplayer.Playlist.Manage.main.Down_Grey := TMonochromeEffect.Create(vSoundplayer.Playlist.Manage.main.Down);
    ...
    vSoundplayer.Playlist.Manage.main.Merge_Glow := TGlowEffect.Create(vSoundplayer.Playlist.Manage.main.Merge);
    ...
    vSoundplayer.Playlist.Manage.main.Merge_Grey := TMonochromeEffect.Create(vSoundplayer.Playlist.Manage.main.Merge);
    ...
    vSoundplayer.Playlist.Manage.main.Split_Glow := TGlowEffect.Create(vSoundplayer.Playlist.Manage.main.Split);
    ...
    vSoundplayer.Playlist.Manage.main.Split_Grey := TMonochromeEffect.Create(vSoundplayer.Playlist.Manage.main.Split);
...
begin
  ...
  begin
    ...
    addons.soundplayer.Ini.Ini.WriteString('Playlists', 'ActivePlaylistName', vSoundplayer.Playlist.Manage.main.Grid.Cells[1, vPlaylistNum]);
...
begin
  ...
  begin
    ...
    if vSoundplayer.Playlist.Manage.main.Grid.Selected <> vSoundplayer.Playlist.Manage.main.Grid.RowCount - 1 then
...
procedure uSoundplayer_Playlist_Manage_Grid_SelectForMerge(vSelected: Integer);
begin
  ShowMessage('You have selected the ' + addons.soundplayer.Playlist.Manage_Selected.ToString + ' and the ' + vSelected.ToString);
