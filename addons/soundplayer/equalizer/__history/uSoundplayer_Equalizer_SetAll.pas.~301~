...
begin
  ...
  uLoad_SetAll_CreateHeader(vSoundplayer.EQ.Panel, 'A_SP_Equalizer', addons.soundplayer.Path.Images +
    'sp_equalizer.png', 'Equalizer');
  ...
  uLoad_SetAll_CreateHeader(vSoundplayer.EQ.Preset, 'A_SP_Equalizer_Preset', addons.soundplayer.Path.Images +
    'sp_equalizer.png', 'Presets');
