...
begin
  ...
  vSoundplayer.tag.mp3.Info.General.Loaded.IsChecked := soundplayer.player_actions.Tag.mp3.Info_ID3v2.General.Loaded;
  ...
  vSoundplayer.tag.mp3.Info.General.Filename.Text := 'Filename : ' + soundplayer.player_actions.Tag.mp3.Info_ID3v2.General.Filename;
  ...
  vSoundplayer.tag.mp3.Info.General.MajorVersion.Text := 'Major Version : ' + soundplayer.player_actions.Tag.mp3.Info_ID3v2.General.MajorVersion.ToString;
  ...
  vSoundplayer.tag.mp3.Info.General.MinorVersion.Text := 'Minor Version : ' + soundplayer.player_actions.Tag.mp3.Info_ID3v2.General.MinorVersion.ToString;
  ...
  vSoundplayer.tag.mp3.Info.General.Size.Text := 'Size : ' + soundplayer.player_actions.Tag.mp3.Info_ID3v2.General.Size.ToString + ' bytes';
  ...
  vSoundplayer.tag.mp3.Info.General.FramesCount.Text := 'Frames Count : ' + soundplayer.player_actions.Tag.mp3.Info_ID3v2.General.FramesCount.ToString;
  ...
  vSoundplayer.tag.mp3.Info.General.BitRate.Text := 'BitRate : ' + soundplayer.player_actions.Tag.mp3.Info_ID3v2.General.BitRate.ToString + ' bps';
  ...
  vSoundplayer.tag.mp3.Info.General.CoverArtCount.Text := 'Cover Art Count : ' + soundplayer.player_actions.Tag.mp3.Info_ID3v2.General.CoverArtCount.ToString;
  ...
  vSoundplayer.tag.mp3.Info.General.PlayTime.Text := 'Play : ' + soundplayer.player_actions.Tag.mp3.Info_ID3v2.General.PlayTime.ToString + ' times';
  ...
  vSoundplayer.tag.mp3.Info.Mpeg.FrameSize.Text := 'Frame Size : ' + soundplayer.player_actions.Tag.mp3.Info_ID3v2.Mpeg.FrameSize.ToString;
  ...
  vSoundplayer.tag.mp3.Info.Mpeg.SampleRate.Text := 'Sample Rate : ' + soundplayer.player_actions.Tag.mp3.Info_ID3v2.Mpeg.SampleRate.ToString + ' Hz';
  ...
  vSoundplayer.tag.mp3.Info.Mpeg.BitRate.Text := 'BitRate : ' + soundplayer.player_actions.Tag.mp3.Info_ID3v2.Mpeg.BitRate.ToString + ' bps';
  ...
  vSoundplayer.tag.mp3.Info.Mpeg.Padding.IsChecked := soundplayer.player_actions.Tag.mp3.Info_ID3v2.Mpeg.Padding;
  ...
  vSoundplayer.tag.mp3.Info.Mpeg.Copyrighted.IsChecked := soundplayer.player_actions.Tag.mp3.Info_ID3v2.Mpeg.Copyrighted;
  ...
  vSoundplayer.tag.mp3.Info.Mpeg.Quality.Text := 'Sound Quality : ' + soundplayer.player_actions.Tag.mp3.Info_ID3v2.Mpeg.Quality.ToString;
  ...
  vSoundplayer.tag.mp3.Info.Mpeg.ChannelMode.Text := 'Channel Mode : ' + soundplayer.player_actions.Tag.mp3.Info_ID3v2.Mpeg.ChannelMode;
  ...
  vSoundplayer.tag.mp3.Info.Mpeg.Layer.Text := 'Layers : ' + soundplayer.player_actions.Tag.mp3.Info_ID3v2.Mpeg.Layer;
  ...
  vSoundplayer.tag.mp3.Info.Mpeg.ExtensionMode.Text := 'Mode Extension : ' + soundplayer.player_actions.Tag.mp3.Info_ID3v2.Mpeg.ExtensionMode;
