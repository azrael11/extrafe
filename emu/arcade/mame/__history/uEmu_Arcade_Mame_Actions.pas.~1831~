...
begin
  ...
  begin
    ...
    begin
      mame.Main.Video.Active := uDB_AUser.Local.Emulators.Arcade_D.Media.Videos + mame.Gamelist.ListRoms[mame.Gamelist.Selected] + '.mp4';
      mame.Main.Video.Is_Aspect_Set := False;
  ...
  begin
    vImageExists := False;
    case IndexStr(uDB_AUser.Local.Emulators.Arcade_D.Mame_D.View_Mode, ['Snapshots', 'Cabinets', 'Control Panels', 'Flyers', 'Marquees', 'Pcbs',
      'Artwork Preview', 'Bosses', 'How To', 'Logos', 'Scores', 'Selects', 'Titles', 'Versus', 'Game Over', 'Ends', 'Warnings']) of
      0:
        if FileExists(uDB_AUser.Local.Emulators.Arcade_D.Media.Snapshots + mame.Gamelist.ListRoms[mame.Gamelist.Selected] + '.png') then
          Activate_Animation(uDB_AUser.Local.Emulators.Arcade_D.Media.Snapshots + mame.Gamelist.ListRoms[mame.Gamelist.Selected] + '.png')
        else
          Activate_Animation(uDB_AUser.Local.Emulators.Arcade_D.Media.Snapshots + 'image_not_found.png');
      1:
