...
begin
  ...
  vMame.Scene.List.List_Control_Item[0] := TTabItem.Create(vMame.Scene.List.List_Control);
  vMame.Scene.List.List_Control_Item[0].Name := 'Main_Config_Profile_Avatar_Main_TabItem_0';
  vMame.Scene.List.List_Control_Item[0].Parent := vMame.Scene.List.List_Control;
