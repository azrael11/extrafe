...
type
  TEMU_MAME_SCENE_GAMELIST_INFO_FILTERS_WINDOW_FILTER_PANELS = record
    Panel: TPanel;
    Filter_Name: TText;
    Choose: TComboBox;
...
type
  TEMU_MAME_SCENE_GAMELIST_INFO_FILTERS = record
    Icon: TText;
    Icon_Glow: TGlowEffect;
    Back: TImage;
    Text: TText;
    Window: TEMU_MAME_SCENE_GAMELIST_INFO_FILTERS_WINDOW;
  end;
...
type
  TEMU_MAME_SCENE_SNAPSHOT_GROUP_IMAGE = record
    ...
    Image_Width_Ani: TFloatAnimation;
...
type
  TEMU_MAME_SCENE = record
    ...
    Gamelist: TEMU_MAME_SCENE_GAMELIST_INFO;
    Right: TImage;
    Right_Anim: TFloatAnimation;
...
type
  TEMU_FILTERS = record
    ...
    Temp_ListRoms_Final: TStringList;
    Temp_ListGames_Final: TStringList;
    Temp_ListRoms: TStringList;
    Temp_ListGames: TStringList;
    Compo_Done: Boolean;
    Filter_Done: Boolean;
  end;
...
procedure TEMU_GAMELISTS_TIMER.OnTimer(Sender: TObject);
begin
...
mame.Config.Input.Mouse.Checkbox.Free;
mame.Config.Input.Mouse.Combobox.Free;
mame.Config.Input.Mouse.Button.Free;
mame.Config.Input.Mouse.OpenDialog.Free;
mame.Config.Input.Mouse.TabItem.Free;
