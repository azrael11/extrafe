...
begin
  ...
  CreateHeader(vMame.Config.Panel.Dirs.Media.Check.Panel, 'IcoMoon-Free', #$e933, TAlphaColorRec.DeepSkyBlue,
...
begin
  ...
  begin
    ...
    vMame.Config.Panel.Dirs.Media.Found[vi].Text := '(Found : ' + uWindows.File_Count(vMame.Config.Panel.Dirs.Media.Edit[vi].Text, vType).ToString + ' files)';
