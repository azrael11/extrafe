...
begin
  ...
  begin
    ...
    begin
      ...
      vMame.Config.Panel.Dirs.Roms_Del[vi].StyledSettings := vMame.Config.Panel.Dirs.Roms_Del[vi]
      ...
      vMame.Config.Panel.Dirs.Roms_Del[vi].OnClick := mame.Config.Input.Mouse.SpeedButton.onMouseClick;
      vMame.Config.Panel.Dirs.Roms_Del[vi].TagFloat := 10;
      vMame.Config.Panel.Dirs.Roms_Del[vi].Tag := vi;
