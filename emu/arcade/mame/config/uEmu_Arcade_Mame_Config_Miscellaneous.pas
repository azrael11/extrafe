...
begin
  ...
  vMame.Config.Panel.Misc.OpenDialog.OnClose:= mame.Config.Input.Mouse.OpenDialog.OnClose;
  ...
  vMame.Config.Panel.Misc.Checkbox[0].Parent:= vMame.Config.Scene.Right_Panels[10];
  ...
  vMame.Config.Panel.Misc.Checkbox[0].OnClick:= mame.Config.Input.Mouse.Checkbox.onMouseClick;
  vMame.Config.Panel.Misc.Checkbox[0].Visible:= True;

  vMame.Config.Panel.Misc.Checkbox[1]:= TCheckBox.Create(vMame.Config.Scene.Right_Panels[10]);
  vMame.Config.Panel.Misc.Checkbox[1].Name:= 'Mame_Misc_Checkbox_EnableInternalDebugger';
  vMame.Config.Panel.Misc.Checkbox[1].Parent:= vMame.Config.Scene.Right_Panels[10];
  ...
  vMame.Config.Panel.Misc.Checkbox[1].OnClick:= mame.Config.Input.Mouse.Checkbox.onMouseClick;
  vMame.Config.Panel.Misc.Checkbox[1].Visible:= True;

  vMame.Config.Panel.Misc.Checkbox[2]:= TCheckBox.Create(vMame.Config.Scene.Right_Panels[10]);
  vMame.Config.Panel.Misc.Checkbox[2].Name:= 'Mame_Misc_Checkbox_SleepWhenPossible';
  vMame.Config.Panel.Misc.Checkbox[2].Parent:= vMame.Config.Scene.Right_Panels[10];
  ...
  vMame.Config.Panel.Misc.Checkbox[2].OnClick:= mame.Config.Input.Mouse.Checkbox.onMouseClick;
  vMame.Config.Panel.Misc.Checkbox[2].Visible:= True;

  vMame.Config.Panel.Misc.Checkbox[3]:= TCheckBox.Create(vMame.Config.Scene.Right_Panels[10]);
  vMame.Config.Panel.Misc.Checkbox[3].Name:= 'Mame_Misc_Checkbox_SaveGameStateOnExit';
  vMame.Config.Panel.Misc.Checkbox[3].Parent:= vMame.Config.Scene.Right_Panels[10];
  ...
  vMame.Config.Panel.Misc.Checkbox[3].OnClick:= mame.Config.Input.Mouse.Checkbox.onMouseClick;
  vMame.Config.Panel.Misc.Checkbox[3].Visible:= True;

  vMame.Config.Panel.Misc.Checkbox[4]:= TCheckBox.Create(vMame.Config.Scene.Right_Panels[10]);
  vMame.Config.Panel.Misc.Checkbox[4].Name:= 'Mame_Misc_Checkbox_CoinLockout';
  vMame.Config.Panel.Misc.Checkbox[4].Parent:= vMame.Config.Scene.Right_Panels[10];
  ...
  vMame.Config.Panel.Misc.Checkbox[4].OnClick:= mame.Config.Input.Mouse.Checkbox.onMouseClick;
  vMame.Config.Panel.Misc.Checkbox[4].Visible:= True;

  vMame.Config.Panel.Misc.Checkbox[5]:= TCheckBox.Create(vMame.Config.Scene.Right_Panels[10]);
  vMame.Config.Panel.Misc.Checkbox[5].Name:= 'Mame_Misc_Checkbox_EnableErrorLogFile';
  vMame.Config.Panel.Misc.Checkbox[5].Parent:= vMame.Config.Scene.Right_Panels[10];
  ...
  vMame.Config.Panel.Misc.Checkbox[5].OnClick:= mame.Config.Input.Mouse.Checkbox.onMouseClick;
  vMame.Config.Panel.Misc.Checkbox[5].Visible:= True;

  vMame.Config.Panel.Misc.Groupbox[0]:= TGroupBox.Create(vMame.Config.Scene.Right_Panels[10]);
  vMame.Config.Panel.Misc.Groupbox[0].Name:= 'Mame_Misc_Groupbox_ThreadPriority';
  vMame.Config.Panel.Misc.Groupbox[0].Parent:= vMame.Config.Scene.Right_Panels[10];
  vMame.Config.Panel.Misc.Groupbox[0].SetBounds(10,170,((vMame.Config.Scene.Right_Panels[10].Width/ 2)- 15),100);
  ...
  vMame.Config.Panel.Misc.Trackbar.OnChange:= mame.Config.Input.Mouse.Trackbar.OnChange;
  ...
  //right
  vMame.Config.Panel.Misc.Groupbox[1]:= TGroupBox.Create(vMame.Config.Scene.Right_Panels[10]);
  vMame.Config.Panel.Misc.Groupbox[1].Name:= 'Mame_Misc_Groupbox_ArtworkOptions';
  vMame.Config.Panel.Misc.Groupbox[1].Parent:= vMame.Config.Scene.Right_Panels[10];
  vMame.Config.Panel.Misc.Groupbox[1].SetBounds(((vMame.Config.Scene.Right_Panels[10].Width/ 2)+ 5),40,((vMame.Config.Scene.Right_Panels[10].Width/ 2)- 15),160);
  ...
  vMame.Config.Panel.Misc.Checkbox[6].OnClick:= mame.Config.Input.Mouse.Checkbox.onMouseClick;
  ...
  vMame.Config.Panel.Misc.Checkbox[7].OnClick:= mame.Config.Input.Mouse.Checkbox.onMouseClick;
  ...
  vMame.Config.Panel.Misc.Checkbox[8].OnClick:= mame.Config.Input.Mouse.Checkbox.onMouseClick;
  ...
  vMame.Config.Panel.Misc.Checkbox[9].OnClick:= mame.Config.Input.Mouse.Checkbox.onMouseClick;
  ...
  vMame.Config.Panel.Misc.Checkbox[10].OnClick:= mame.Config.Input.Mouse.Checkbox.onMouseClick;
  ...
  vMame.Config.Panel.Misc.Checkbox[11].OnClick:= mame.Config.Input.Mouse.Checkbox.onMouseClick;
  vMame.Config.Panel.Misc.Checkbox[11].Visible:= True;

  //middle
  vMame.Config.Panel.Misc.Groupbox[2]:= TGroupBox.Create(vMame.Config.Scene.Right_Panels[10]);
  vMame.Config.Panel.Misc.Groupbox[2].Name:= 'Mame_Misc_Groupbox_BiosSelection';
  vMame.Config.Panel.Misc.Groupbox[2].Parent:= vMame.Config.Scene.Right_Panels[10];
  vMame.Config.Panel.Misc.Groupbox[2].SetBounds(10,275,(vMame.Config.Scene.Right_Panels[10].Width- 20),70);
  ...
  vMame.Config.Panel.Misc.Combobox.OnChange:= mame.Config.Input.Mouse.Combobox.OnChange;
  vMame.Config.Panel.Misc.Combobox.Visible:= True;

  vMame.Config.Panel.Misc.Groupbox[3]:= TGroupBox.Create(vMame.Config.Scene.Right_Panels[10]);
  vMame.Config.Panel.Misc.Groupbox[3].Name:= 'Mame_Misc_Groupbox_CheatFile';
  vMame.Config.Panel.Misc.Groupbox[3].Parent:= vMame.Config.Scene.Right_Panels[10];
  vMame.Config.Panel.Misc.Groupbox[3].SetBounds(10,350,(vMame.Config.Scene.Right_Panels[10].Width- 20),90);
  ...
  vMame.Config.Panel.Misc.Button[0].OnClick:= mame.Config.Input.Mouse.Button.onMouseClick;
  ...
  vMame.Config.Panel.Misc.Button[1].OnClick:= mame.Config.Input.Mouse.Button.onMouseClick;
  vMame.Config.Panel.Misc.Button[1].Visible:= True;

  vMame.Config.Panel.Misc.Checkbox[12]:= TCheckBox.Create(vMame.Config.Scene.Right_Panels[10]);
  vMame.Config.Panel.Misc.Checkbox[12].Name:= 'Mame_Misc_Checkbox_SkipGameInformation';
  vMame.Config.Panel.Misc.Checkbox[12].Parent:= vMame.Config.Scene.Right_Panels[10];
  ...
  vMame.Config.Panel.Misc.Checkbox[12].OnClick:= mame.Config.Input.Mouse.Checkbox.onMouseClick;
  vMame.Config.Panel.Misc.Checkbox[12].Visible:= True;

  vMame.Config.Panel.Misc.Checkbox[13]:= TCheckBox.Create(vMame.Config.Scene.Right_Panels[10]);
  vMame.Config.Panel.Misc.Checkbox[13].Name:= 'Mame_Misc_Checkbox_QuitGameConfirmation';
  vMame.Config.Panel.Misc.Checkbox[13].Parent:= vMame.Config.Scene.Right_Panels[10];
  ...
  vMame.Config.Panel.Misc.Checkbox[13].OnClick:= mame.Config.Input.Mouse.Checkbox.onMouseClick;
  vMame.Config.Panel.Misc.Checkbox[13].Visible:= True;

  vMame.Config.Panel.Misc.Checkbox[14]:= TCheckBox.Create(vMame.Config.Scene.Right_Panels[10]);
  vMame.Config.Panel.Misc.Checkbox[14].Name:= 'Mame_Misc_Checkbox_DisplayMouseCursor';
  vMame.Config.Panel.Misc.Checkbox[14].Parent:= vMame.Config.Scene.Right_Panels[10];
  ...
  vMame.Config.Panel.Misc.Checkbox[14].OnClick:= mame.Config.Input.Mouse.Checkbox.onMouseClick;
...
begin
  if vName= 'Mame_Misc_Button_SelectCheatFile' then
    begin
      mame.Config.Panel.Misc.OpenDialog_Result:= 'cheat_file';
...
var
  vString: String;
begin
  if mame.Config.Panel.Misc.OpenDialog_Result= 'cheat_file' then
    begin
