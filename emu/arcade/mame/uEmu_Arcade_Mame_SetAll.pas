...
begin
  ...
  vMame.Scene.Main.WrapMode:= TImageWrapMode.Fit;
  ...
  vMame.Scene.Gamelist.Search:= TImage.Create(vMame.Scene.Left);
  vMame.Scene.Gamelist.Search.Name:= 'Mame_Gamelist_Search_Image';
  vMame.Scene.Gamelist.Search.Parent:= vMame.Scene.Left;
  vMame.Scene.Gamelist.Search.SetBounds(4,18,24,24);
  ...
  vMame.Scene.Snap.Black_Reflection.Enabled:= True;

  //DONE 1 -oNikos Kordas -cVideoPlayer: Hold on the hole video project as i found a bug waiting the programmer to solve it
  ...
  vMame.Scene.Snap.Type_Frame:= TImage.Create(vMame.Scene.Right);
  vMame.Scene.Snap.Type_Frame.Name:= 'Mame_Snap_Frame_Image';
  vMame.Scene.Snap.Type_Frame.Parent:= vMame.Scene.Right;
  vMame.Scene.Snap.Type_Frame.SetBounds(0,0,0,0);
  vMame.Scene.Snap.Type_Frame.WrapMode:= TImageWrapMode.Fit;
  vMame.Scene.Snap.Type_Frame.Visible:= False;

  vMame.Scene.Snap.Type_Frame_Reflection:= TReflectionEffect.Create(vMame.Scene.Snap.Type_Frame);
  vMame.Scene.Snap.Type_Frame_Reflection.Name:= 'Mame_Snap_TypeFrame_Reflaction';
  vMame.Scene.Snap.Type_Frame_Reflection.Parent:= vMame.Scene.Snap.Type_Frame;
  vMame.Scene.Snap.Type_Frame_Reflection.Offset:= 5;
  vMame.Scene.Snap.Type_Frame_Reflection.Enabled:= True;
