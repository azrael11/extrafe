  ...
  begin
    ...
    begin
      if UpperCase(vKey) = 'ESC' then
        ...
        uView_Mode_Video_Actions.Enter;
    end;
    ...
    begin
      ...
      begin
        ...
        uView_Mode_Video_Actions.Search_Backspace
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        Emu_VM_Video_Var.gamelist.Selected := Emu_VM_Video_Var.search.Selected;
        uView_Mode_Video_Actions.Refresh_Gamelist(Emu_VM_Video_Var.gamelist.Selected, Emu_VM_Video_Var.gamelist.Total_Games, Emu_VM_Video_Var.gamelist.games,
