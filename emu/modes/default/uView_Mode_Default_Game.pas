...
begin
  ...
  Emu_VM_Video.GameMenu.Favorite.Ani_Selected.OnFinish := uView_Mode_Default_AllTypes.vAll_ANI.OnFinish;
...
begin
  ...
  if Emu_VM_Video_Var.Favorites_Open then
    uDB.Query_Update(uDB.Arcade_Query, Emu_XML.Game.play_count_refresh_status, 'play_count_id_' + uDB_AUser.Local.USER.Num.ToString, play_int.ToString, 'romname',
