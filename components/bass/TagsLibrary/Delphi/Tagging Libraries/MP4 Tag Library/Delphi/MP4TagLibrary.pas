//********************************************************************************************************************************
//*                                                                                                                              *
//*     MP4 Tag Library 1.0.31.66 © 3delite 2012-2015                                                                            *
...
Const
    MP4TAGLIBRARY_VERSION = $01003166;
...
begin
    ...
    HighWord := 0;
    case Data.Size of
        1: Result := GetAsInteger8;
        2: Result := GetAsInteger16;
        4: Result := GetAsInteger32;
        6: Result := GetAsInteger48(LowDWord, HighWord);
        8: Result := GetAsInteger64(LowDWord, HighDWord);
    end;
end;
...
begin
    Result := '';
    if FindAtom('stik') <> nil then begin
...
begin
    ...
    LowDWord := 0;
    HighWord := 0;
    if GetInteger48('trkn', LowDWord, HighWord) > - 1 then begin
...
begin
    ...
    LowDWord := 0;
    HighWord := 0;
    if GetInteger48('disk', LowDWord, HighWord) > - 1 then begin
