//********************************************************************************************************************************
//*                                                                                                                              *
//*     Flac Tag Library 2.0.16.41 © 3delite 2013-2015                                                                           *
...
begin
    ...
    try
        ...
        if GetInfo(FileStream, False) <> FLACTAGLIBRARY_SUCCESS then begin
            Exit;
        end;
    finally
...
begin
    ...
    try
        Stream.Seek(0, soBeginning);
        //reload all except tag fields
        if GetInfo(Stream, False) <> FLACTAGLIBRARY_SUCCESS then begin
            Exit;
        end;
    except
        Exit;
...
begin
    ...
    try
        FileDateTime := 0;
        if NOT Assigned(Stream) then begin
            if bTAG_PreserveDate then begin
...
begin
    ...
    for i := 0 to Length(FlacTag.Tags) - 1 do begin
