...
private:
	...
	System::AnsiString __fastcall GetMatchedText();
	...
	void *FHints;
	void *FCharTable;
	System::WideChar *FSubjectPChar;
	bool FHasStoredGroups;
	_TALPerlRegEx__1 FStoredGroups;
	System::AnsiString __fastcall GetSubjectLeft();
	System::AnsiString __fastcall GetSubjectRight();
...
public:
	__fastcall TALPerlRegEx();
	__fastcall virtual ~TALPerlRegEx();
	...
	bool __fastcall Match()/* overload */;
	...
	System::AnsiString __fastcall Replace();
	bool __fastcall ReplaceAll();
	System::AnsiString __fastcall ComputeReplacement();
...
public:
	__fastcall TALPerlRegExList();
	__fastcall virtual ~TALPerlRegExList();
