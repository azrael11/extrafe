...
public:
	...
	private:
		...
		int FIndex;
		System::Generics::Collections::TPair__2<TKey,TValue> __fastcall GetCurrent();
		
	protected:
		virtual System::Generics::Collections::TPair__2<TKey,TValue> __fastcall DoGetCurrent();
	...
	protected:
		virtual System::Generics::Collections::TEnumerator__1<TValue>* __fastcall DoGetEnumerator();
		
	public:
		__fastcall TValueCollection(TALDictionary__2<TKey,TValue>* const ADictionary);
		HIDESBASE TALDictionary__2<TKey,TValue>::TValueEnumerator* __fastcall GetEnumerator();
		virtual System::DynamicArray<TValue> __fastcall ToArray() _FINAL_ATTRIBUTE;
		__property int Count = {read=GetCount, nodefault};
	public:
		/* {System_Generics_Collections}TEnumerable<ALQuickSortList_TALDictionary<TKey,TValue>_TValue>.Destroy */ inline __fastcall virtual ~TValueCollection() { }
	...
	protected:
		virtual System::Generics::Collections::TEnumerator__1<TKey>* __fastcall DoGetEnumerator();
		
	public:
		__fastcall TKeyCollection(TALDictionary__2<TKey,TValue>* const ADictionary);
		HIDESBASE TALDictionary__2<TKey,TValue>::TKeyEnumerator* __fastcall GetEnumerator();
		virtual System::DynamicArray<TKey> __fastcall ToArray() _FINAL_ATTRIBUTE;
		__property int Count = {read=GetCount, nodefault};
	public:
		/* {System_Generics_Collections}TEnumerable<ALQuickSortList_TALDictionary<TKey,TValue>_TKey>.Destroy */ inline __fastcall virtual ~TKeyCollection() { }
...
protected:
	virtual System::Generics::Collections::TEnumerator__1<System::Generics::Collections::TPair__2<TKey,TValue> >* __fastcall DoGetEnumerator();
...
public:
	...
	__fastcall virtual ~TALDictionary__2();
	...
	virtual System::DynamicArray<System::Generics::Collections::TPair__2<TKey,TValue> > __fastcall ToArray() _FINAL_ATTRIBUTE;
	__property TValue Items[const TKey Key] = {read=GetItem, write=SetItem/*, default*/};
	__property int Count = {read=FCount, nodefault};
	
private:
	typedef void __fastcall (__closure *_dt_Alquicksortlist_1)(System::TObject* Sender, const TKey Item, System::Generics::Collections::TCollectionNotification Action);
	_dt_Alquicksortlist_1 FOnKeyNotify;
	typedef void __fastcall (__closure *_dt_Alquicksortlist_2)(System::TObject* Sender, const TValue Item, System::Generics::Collections::TCollectionNotification Action);
...
public:
	...
	typedef void __fastcall (__closure *_dt_Alquicksortlist_3)(System::TObject* Sender, const TKey Item, System::Generics::Collections::TCollectionNotification Action);
	__property _dt_Alquicksortlist_3 OnKeyNotify = {read=FOnKeyNotify, write=FOnKeyNotify};
	typedef void __fastcall (__closure *_dt_Alquicksortlist_4)(System::TObject* Sender, const TValue Item, System::Generics::Collections::TCollectionNotification Action);
...
public:
	...
	/* {ALQuickSortList}TALDictionary<ALQuickSortList_TALObjectDictionary<TKey,TValue>_TKey,ALQuickSortList_TALObjectDictionary<TKey,TValue>_TValue>.Destroy */ inline __fastcall virtual ~TALObjectDictionary__2() { }
