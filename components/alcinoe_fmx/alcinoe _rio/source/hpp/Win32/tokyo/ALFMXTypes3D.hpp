...
public:
	/* TMaterial.Create */ inline __fastcall virtual TALCanvasExternalOESTextureMaterial() : Fmx::Materials::Canvas::TCanvasTextureMaterial() { }
...
public:
	/* TMaterial.Create */ inline __fastcall virtual TALCanvas420YpCbCr8BiPlanarVideoRangeTextureMaterial() : Fmx::Materials::Canvas::TCanvasTextureMaterial() { }
...
public:
	/* TMaterial.Create */ inline __fastcall virtual TALCanvas420YpCbCr8PlanarTextureMaterial() : Fmx::Materials::Canvas::TCanvasTextureMaterial() { }
